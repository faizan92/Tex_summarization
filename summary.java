...
import javaapplication1.slist;
import javaapplication1.Stopword;
import javaapplication1.Special;
import javaapplication1.Sentense;
import javaapplication1.FacebookImpl;
...
//	jtb.add(jb9); //Have to remove comments
    ...
    public double difpos(String str1, String str2) { //AI Part Hidden marko model
        int s1 = str1.length();
        int s2 = str2.length();
        int sz = (s1 > s2) ? s1 : s2;
        int mz = (s1 < s2) ? s1 : s2;
